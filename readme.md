# YOLOv11 Apple Rot Detection System

## Body

YOLOv11 Apple Rottenness Detection System Based on Deep Learning YOLOv11, the Apple Fresh Rottenness Detection System (YOLOv11+YOLO dataset + UI interface + login and registration interface + Python project source code + model)

nc: 2 classes,
Names: ['apple', 'damaged_apple'],
Dataset quantity: training set 489, validation set 178, test set 30.
